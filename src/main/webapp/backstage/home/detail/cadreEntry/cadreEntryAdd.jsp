    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            <img border="0" width="13" height="13"
                 src="<%=basePath %>backstage/home/detail/style/images/title_arrow.gif"/> 添加新干部
        </div>
    </div>
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="<%=basePath %>cadreentry/saveAdd" method="post">
        <!-- 本段标题（分段标题） -->
                ...
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        ...
                        <tr>
                            <td width="80px">类型</td>
                            <td>
                                <input type="text" name="type" class="InputStyle"/> *
                            </td>
                        </tr>
                    </table>
                </div>
