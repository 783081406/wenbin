...
<html>
<head>
    <title>评分申述update</title>
    <meta charset="utf-8">
    <meta name="description" content="评分申述update">
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="<%=basePath %>representation/saveUpdate" method="post">
        <!-- 本段标题（分段标题） -->
                ...
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="name" disabled="disabled" class="InputStyle" value="${name}"/>
                                *
                                <input type="hidden" name="rid" value="${rid}"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="80px">提交理由</td>
                            <td>
                                <input type="text" name="mark" class="InputStyle" value="${mark}"/> *
                            </td>
                        </tr>
                    </table>
                </div>
