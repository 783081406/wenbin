...
<html>
<head>
    <title>活动评分update</title>
    <meta charset="utf-8">
    <meta name="description" content="活动评分update">
    ...
    <div id="TitleArea_Title">
        <div id="TitleArea_Title_Content">
            <img border="0" width="13" height="13"
                 src="<%=basePath %>backstage/home/detail/style/images/title_arrow.gif"/> 修改评分
        </div>
    </div>
...
<div id="MainArea">
    <!-- 表单内容 -->
    <form action="<%=basePath %>grade/getThisActivitySaveUpdate" method="post">
        <!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
                <div class="ItemBlock2">
                    <table cellpadding="0" cellspacing="0" class="mainForm">
                        <tr>
                            <td width="80px">参与人员名称</td>
                            <td>
                                <input type="text" name="name" disabled="disabled" class="InputStyle"
                                       value="${name}"/> *
                        ...
                        <tr>
                            <td width="80px">评分</td>
                            <td>
                                <input type="text" name="score" class="InputStyle" value="${score}"/> *
                            </td>
                        </tr>
                    </table>
                </div>
